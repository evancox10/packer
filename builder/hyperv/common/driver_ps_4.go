...
func (d *HypervPS4Driver) CreateVirtualMachine(vmName string, path string, ram int64, diskSize int64, diskBlockSize int64, switchName string, generation uint) error {
	return hyperv.CreateVirtualMachine(vmName, path, ram, diskSize, diskBlockSize, switchName, generation)
}
